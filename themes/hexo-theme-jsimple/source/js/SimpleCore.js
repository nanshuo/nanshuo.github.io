var SimpleCore = {
    ...
    init: function (params) {
        ...
        $(document).on('click', '.btn-sns-qr', function (e) {
            ...
            if (SimpleCore.snsQRCode != '') {
                SimpleCore.alert('微信联系我','<img style="width:180px;background:#fff;" src="' + SimpleCore.snsQRCode + '">');
            } else {
        ...
        $(document).on('click', '.btn-thumbs-up', function (e) {
            ...
            if (SimpleCore.donateImg != '') {
                SimpleCore.alert('点个赞，你高兴就好','<img style="width:350px;background:#fff;" src="' + SimpleCore.donateImg + '">');
            } else {
                SimpleCore.alert('未开通自定义功能','<h4 style="text-align: center;margin: 0">联系博主试试看 ：）</h4>');
            }
        });
    ...
    changeReadModel: function () {
        ...
        if (SimpleCore.getLocalData('read-mode') == 'night') {
            ...
            $(".cover-img").css({
                'background': "url('/images/togger.jpeg')",
                'background-image': '/images/togger.jpeg',
